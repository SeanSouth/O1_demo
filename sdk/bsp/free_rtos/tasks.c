				...
				for( x = 0; x < uxArraySize; x++ )
				{
					...
					if( ulStatsAsPercentage > 0UL )
					{
						...
						#else
						{
							...
							sprintf( pcWriteBuffer, "\t%u\t%u\t%u\t\t%u%%\r\n", ( unsigned int ) pxTaskStatusArray[ x ].eCurrentState,( unsigned int ) pxTaskStatusArray[ x ].uxCurrentPriority,( unsigned int ) pxTaskStatusArray[ x ].usStackHighWaterMark, ( unsigned int ) ulStatsAsPercentage );
						}
						#endif
					}
					else
