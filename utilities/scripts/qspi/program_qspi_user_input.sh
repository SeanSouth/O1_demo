...
BIN2IMAGE="$base_dir/program_qspi_bin2image.sh"
...
$CLI_PROGRAMMER -i $BAUDRATE -s 115200 $TX_PORT $TX_PIN $RX_PORT $RX_PIN $DEVNODE write_qspi 0x0 $IMAGE
